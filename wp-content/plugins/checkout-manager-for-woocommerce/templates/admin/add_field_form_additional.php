<div class="panel woocommerce_options_panel" id="additional_<?php echo $loop; ?>" style="display: none;">

	<div class="options_group hide_if_grouped">
		<h3><a class="button remove_checkout_field" remove-key="additional_<?php echo $loop; ?>" href="javascript:void(0);">Remove</a></h3>
			<table>
				<tbody>
					<tr>                
					...
					<tr>                
						<td width="40%">Name</td>
						<td>
							<input placeholder='always use additional_ as prefix' type="text" style="width:250px;" class="remove_key_field_<?php echo $loop; ?>" value="additional_" name="fieldname[<?php echo $loop; ?>]">
						</td>
					</tr>
					<tr>                   
						<td>Type</td>
					...
					<tr>                    
						<td>Validation</td>
						<td>
							<select style="width:250px;" class="additional_field_validation" placeholder="Select validations" name="fieldvalidate[<?php echo $loop; ?>]">
