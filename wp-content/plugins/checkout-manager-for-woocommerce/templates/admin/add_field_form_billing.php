<div class="panel woocommerce_options_panel" id="billing_<?php echo $loop; ?>" style="display: none;">

	<div class="options_group hide_if_grouped">
		<h3><a class="button remove_checkout_field" remove-key="billing_<?php echo $loop; ?>" href="javascript:void(0);">Remove</a></h3>
			<table>
				<tbody>
					<tr>                
					...
					<tr>                
						<td width="40%">Name</td>
						<td>
							<input placeholder='always use billing_ as prefix' type="text" style="width:250px;" class="remove_key_field_<?php echo $loop; ?>" value="billing_" name="fieldname[<?php echo $loop; ?>]">
						</td>
					</tr>
					<tr>                   
						<td>Type</td>
					...
					<tr>                    
						<td>Validation</td>
						<td>
							<select style="width:250px;" class="billing_field_validation" placeholder="Select validations" name="fieldvalidate[<?php echo $loop; ?>]">
