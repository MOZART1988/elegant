...
function woo_wc_search_form( $form ) {
    ...
    $form = '
	<ul>
    <li class="search"><form role="search" method="get" id="searchform" action="' . esc_url(home_url( '/' )) . '" >
    <label class="screen-reader-text 123">' . __( 'Search Products:' , 'woothemes' ) . '</label>
    <span id="search_btn"><em></em></span>
    <div id="search-form">
    	<input type="search" class="input-text" id="input-text-active" placeholder="'. esc_attr__( 'Поиск по 15000 товаров', 'woothemes' ) .'" value="' . get_search_query() . '" name="s">
		<div id="sub"></div>
    </div>
