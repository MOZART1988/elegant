...
class WC_Product_Cat_List_Walker extends Walker {
	...
	public function start_el( &$output, $cat, $depth = 0, $args = array(), $current_object_id = 0 ) {
		$output .= '<li trololo class="cat-item abc cat-item-' . $cat->term_id;
		...
		$output .=  '"><div imtrololo><a href="' . get_term_link( (int) $cat->term_id, 'product_cat' ) . '">' . __( $cat->name, 'woocommerce' ) . '</a><h4 class="dropdown"></h4></div>';
